(()=>{'use strict';
const FILES=["table_tennis_status.json","table_tennis_model.json","table_tennis_upcoming.json","table_tennis_candidates.json"];
const API="/api/sportybet-table-tennis";
