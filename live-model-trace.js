...
async function renderBehavior(p){
 ...
 let box=document.getElementById('ms-behavior-context');if(!box){box=document.createElement('section');box.id='ms-behavior-context';box.className='panel';const anchor=document.getElementById('app');if(anchor)anchor.appendChild(box);}
